...
STATIONS = {
    ...
    "3": ["Беговая", "Зенит", "Приморская", "Василеостровская", "Гостиный двор",
          "Маяковская", "Площадь Александра Невского", "Елизаровская",
          "Ломоносовская", "Пролетарская", "Обухово", "Рыбацкое"],
    "4": ["Горный институт", "Театральная", "Спасская", "Достоевская",
    ...
    "6": ["ССВ Путиловская-Нарвская (6-1)", "Путиловская", "Юго-Западная"]
}
